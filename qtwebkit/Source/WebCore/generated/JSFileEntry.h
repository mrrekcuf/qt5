...
public:
    ...
    {
        JSFileEntry* ptr = new (NotNull, JSC::allocateCell<JSFileEntry>(globalObject->vm().heap)) JSFileEntry(structure, globalObject, impl);
...
public:
    ...
    static JSFileEntryPrototype* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSFileEntryPrototype* ptr = new (NotNull, JSC::allocateCell<JSFileEntryPrototype>(vm.heap)) JSFileEntryPrototype(vm, globalObject, structure);
...
private:
    JSFileEntryPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
