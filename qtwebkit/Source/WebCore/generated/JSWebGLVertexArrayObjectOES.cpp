...
{
    return JSWebGLVertexArrayObjectOESPrototype::create(exec->vm(), globalObject, JSWebGLVertexArrayObjectOESPrototype::createStructure(globalObject->vm(), globalObject, globalObject->objectPrototype()));
}
...
{
    return value.inherits(&JSWebGLVertexArrayObjectOES::s_info) ? jsCast<JSWebGLVertexArrayObjectOES*>(asObject(value))->impl() : 0;
}
