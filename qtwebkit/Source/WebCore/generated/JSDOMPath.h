...
public:
    ...
    static JSDOMPathConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSDOMPathConstructor* ptr = new (NotNull, JSC::allocateCell<JSDOMPathConstructor>(*exec->heap())) JSDOMPathConstructor(structure, globalObject);
