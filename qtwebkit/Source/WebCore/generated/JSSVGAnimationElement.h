...
public:
    ...
    static JSSVGAnimationElementConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGAnimationElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimationElementConstructor>(*exec->heap())) JSSVGAnimationElementConstructor(structure, globalObject);
...
#endif
JSC::JSValue jsSVGAnimationElementConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
