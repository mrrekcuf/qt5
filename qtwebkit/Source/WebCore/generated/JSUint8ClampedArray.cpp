...
{
    return getHashTableForGlobalData(exec->vm(), &JSUint8ClampedArrayConstructorTable);
}
...
void JSUint8ClampedArrayConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    ...
    putDirect(exec->vm(), exec->propertyNames().prototype, JSUint8ClampedArrayPrototype::self(exec, globalObject), DontDelete | ReadOnly);
...
{
    { "BYTES_PER_ELEMENT", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsUint8ClampedArrayBYTES_PER_ELEMENT), (intptr_t)0, NoIntrinsic },
    { "subarray", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsUint8ClampedArrayPrototypeFunctionSubarray), (intptr_t)0, NoIntrinsic },
...
{
    return getHashTableForGlobalData(exec->vm(), &JSUint8ClampedArrayPrototypeTable);
}
...
{
    return getHashTableForGlobalData(exec->vm(), &JSUint8ClampedArrayTable);
}
...
void JSUint8ClampedArray::finishCreation(VM& vm)
{
...
{
    return JSUint8ClampedArrayPrototype::create(exec->vm(), globalObject, JSUint8ClampedArrayPrototype::createStructure(exec->vm(), globalObject, JSUint8ArrayPrototype::self(exec, globalObject)));
}
