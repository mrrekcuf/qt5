...
public:
    ...
    {
        JSDirectoryEntrySync* ptr = new (NotNull, JSC::allocateCell<JSDirectoryEntrySync>(globalObject->vm().heap)) JSDirectoryEntrySync(structure, globalObject, impl);
...
public:
    ...
    static JSDirectoryEntrySyncPrototype* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSDirectoryEntrySyncPrototype* ptr = new (NotNull, JSC::allocateCell<JSDirectoryEntrySyncPrototype>(vm.heap)) JSDirectoryEntrySyncPrototype(vm, globalObject, structure);
...
private:
    JSDirectoryEntrySyncPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
