...
public:
    ...
    {
        JSDOMFileSystemSync* ptr = new (NotNull, JSC::allocateCell<JSDOMFileSystemSync>(globalObject->vm().heap)) JSDOMFileSystemSync(structure, globalObject, impl);
...
public:
    ...
    static JSDOMFileSystemSyncPrototype* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSDOMFileSystemSyncPrototype* ptr = new (NotNull, JSC::allocateCell<JSDOMFileSystemSyncPrototype>(vm.heap)) JSDOMFileSystemSyncPrototype(vm, globalObject, structure);
...
private:
    JSDOMFileSystemSyncPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
