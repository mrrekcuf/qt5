...
public:
    ...
    static JSPerformanceNavigationConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSPerformanceNavigationConstructor* ptr = new (NotNull, JSC::allocateCell<JSPerformanceNavigationConstructor>(*exec->heap())) JSPerformanceNavigationConstructor(structure, globalObject);
...
JSC::JSValue jsPerformanceNavigationConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
// Constants
