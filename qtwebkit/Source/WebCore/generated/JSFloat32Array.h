...
public:
    ...
    {
        JSFloat32Array* ptr = new (NotNull, JSC::allocateCell<JSFloat32Array>(globalObject->vm().heap)) JSFloat32Array(structure, globalObject, impl);
...
public:
    ...
    static JSFloat32ArrayPrototype* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSFloat32ArrayPrototype* ptr = new (NotNull, JSC::allocateCell<JSFloat32ArrayPrototype>(vm.heap)) JSFloat32ArrayPrototype(vm, globalObject, structure);
...
private:
    JSFloat32ArrayPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
