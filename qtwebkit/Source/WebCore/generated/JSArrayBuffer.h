...
public:
    ...
    {
        JSArrayBuffer* ptr = new (NotNull, JSC::allocateCell<JSArrayBuffer>(globalObject->vm().heap)) JSArrayBuffer(structure, globalObject, impl);
...
public:
    ...
    static JSArrayBufferPrototype* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSArrayBufferPrototype* ptr = new (NotNull, JSC::allocateCell<JSArrayBufferPrototype>(vm.heap)) JSArrayBufferPrototype(vm, globalObject, structure);
...
private:
    JSArrayBufferPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
