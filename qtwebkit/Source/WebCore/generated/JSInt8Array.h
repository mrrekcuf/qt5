...
public:
    ...
    {
        JSInt8Array* ptr = new (NotNull, JSC::allocateCell<JSInt8Array>(globalObject->vm().heap)) JSInt8Array(structure, globalObject, impl);
...
public:
    ...
    static JSInt8ArrayPrototype* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSInt8ArrayPrototype* ptr = new (NotNull, JSC::allocateCell<JSInt8ArrayPrototype>(vm.heap)) JSInt8ArrayPrototype(vm, globalObject, structure);
...
private:
    JSInt8ArrayPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
