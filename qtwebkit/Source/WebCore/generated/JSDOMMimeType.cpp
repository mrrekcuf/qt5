...
void JSDOMMimeTypeConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    ...
    putDirect(exec->vm(), exec->propertyNames().prototype, JSDOMMimeTypePrototype::self(exec, globalObject), DontDelete | ReadOnly);
...
{
    return JSDOMMimeTypePrototype::create(exec->vm(), globalObject, JSDOMMimeTypePrototype::createStructure(globalObject->vm(), globalObject, globalObject->objectPrototype()));
}
