...
public:
    ...
    {
        JSDOMFileSystem* ptr = new (NotNull, JSC::allocateCell<JSDOMFileSystem>(globalObject->vm().heap)) JSDOMFileSystem(structure, globalObject, impl);
...
public:
    ...
    static JSDOMFileSystemPrototype* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
...
private:
    JSDOMFileSystemPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
