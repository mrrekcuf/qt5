...
void JSStyleSheetListConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    ...
    putDirect(exec->vm(), exec->propertyNames().prototype, JSStyleSheetListPrototype::self(exec, globalObject), DontDelete | ReadOnly);
...
{
    { "item", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsStyleSheetListPrototypeFunctionItem), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
{
    return JSStyleSheetListPrototype::create(exec->vm(), globalObject, JSStyleSheetListPrototype::createStructure(globalObject->vm(), globalObject, globalObject->objectPrototype()));
}
