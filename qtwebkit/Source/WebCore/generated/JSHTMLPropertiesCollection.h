...
public:
    ...
    {
        JSHTMLPropertiesCollection* ptr = new (NotNull, JSC::allocateCell<JSHTMLPropertiesCollection>(globalObject->vm().heap)) JSHTMLPropertiesCollection(structure, globalObject, impl);
...
public:
    ...
    static JSHTMLPropertiesCollectionPrototype* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSHTMLPropertiesCollectionPrototype* ptr = new (NotNull, JSC::allocateCell<JSHTMLPropertiesCollectionPrototype>(vm.heap)) JSHTMLPropertiesCollectionPrototype(vm, globalObject, structure);
...
private:
    JSHTMLPropertiesCollectionPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
