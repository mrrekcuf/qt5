...
LIBS += -L/opt/qt-everywhere-opensource-src-5.5.1/qtwebkit/  -L./ -licui18n -licuuc -licudata -ldl -lSDL -lpdl -ldl -L$$QTPREFIX/plugins/imageformats -L$$QTPREFIX/lib  -L/opt/PalmPDK/lib -llinux-atmoic

QMAKE_CXXFLAGS += -release_extra_cflags="-fno-inline" 
