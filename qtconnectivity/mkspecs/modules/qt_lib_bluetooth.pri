...
include(/opt/qt-everywhere-opensource-src-5.5.1/qtconnectivity/mkspecs/modules-inst/qt_lib_bluetooth.pri)
QT.bluetooth.priority = 1
include(/opt/qt-everywhere-opensource-src-5.5.1/qtconnectivity/mkspecs/modules-inst/qt_lib_bluetooth_private.pri)
