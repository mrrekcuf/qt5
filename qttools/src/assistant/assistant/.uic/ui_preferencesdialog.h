...
public:
    ...
    {
        PreferencesDialogClass->setWindowTitle(QApplication::translate("PreferencesDialogClass", "Preferences", 0));
        fontLabel->setText(QApplication::translate("PreferencesDialogClass", "Font settings:", 0));
        comboBox->clear();
        comboBox->insertItems(0, QStringList()
         << QApplication::translate("PreferencesDialogClass", "Browser", 0)
         << QApplication::translate("PreferencesDialogClass", "Application", 0)
        );
        tabWidget->setTabText(tabWidget->indexOf(fontsTab), QApplication::translate("PreferencesDialogClass", "Fonts", 0));
        label->setText(QApplication::translate("PreferencesDialogClass", "Filter:", 0));
        label_2->setText(QApplication::translate("PreferencesDialogClass", "Attributes:", 0));
        QTreeWidgetItem *___qtreewidgetitem = attributeWidget->headerItem();
        ___qtreewidgetitem->setText(0, QApplication::translate("PreferencesDialogClass", "1", 0));
        filterAddButton->setText(QApplication::translate("PreferencesDialogClass", "Add", 0));
        filterRemoveButton->setText(QApplication::translate("PreferencesDialogClass", "Remove", 0));
        tabWidget->setTabText(tabWidget->indexOf(filtersTab), QApplication::translate("PreferencesDialogClass", "Filters", 0));
        label_3->setText(QApplication::translate("PreferencesDialogClass", "Registered Documentation:", 0));
        docAddButton->setText(QApplication::translate("PreferencesDialogClass", "Add...", 0));
        docRemoveButton->setText(QApplication::translate("PreferencesDialogClass", "Remove", 0));
        tabWidget->setTabText(tabWidget->indexOf(docsTab), QApplication::translate("PreferencesDialogClass", "Documentation", 0));
        groupBox_2->setTitle(QString());
        label_5->setText(QApplication::translate("PreferencesDialogClass", "On help start:", 0));
        helpStartComboBox->clear();
        helpStartComboBox->insertItems(0, QStringList()
         << QApplication::translate("PreferencesDialogClass", "Show my home page", 0)
         << QApplication::translate("PreferencesDialogClass", "Show a blank page", 0)
         << QApplication::translate("PreferencesDialogClass", "Show my tabs from last session", 0)
        );
        groupBox->setTitle(QString());
        label_4->setText(QApplication::translate("PreferencesDialogClass", "Homepage", 0));
        currentPageButton->setText(QApplication::translate("PreferencesDialogClass", "Current Page", 0));
        blankPageButton->setText(QApplication::translate("PreferencesDialogClass", "Blank Page", 0));
        defaultPageButton->setText(QApplication::translate("PreferencesDialogClass", "Restore to default", 0));
        groupBox_3->setTitle(QApplication::translate("PreferencesDialogClass", "Appearance", 0));
        showTabs->setText(QApplication::translate("PreferencesDialogClass", "Show tabs for each individual page", 0));
        tabWidget->setTabText(tabWidget->indexOf(optionsTab), QApplication::translate("PreferencesDialogClass", "Options", 0));
    } // retranslateUi
