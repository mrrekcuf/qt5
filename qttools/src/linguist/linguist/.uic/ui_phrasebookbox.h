...
public:
    ...
    void retranslateUi(QDialog *PhraseBookBox)
    {
        ...
        PhraseBookBox->setWhatsThis(QApplication::translate("PhraseBookBox", "This window allows you to add, modify, or delete entries in a phrase book.", 0));
...
#endif // QT_NO_WHATSTHIS
        newBut->setText(QApplication::translate("PhraseBookBox", "&New Entry", 0));
#ifndef QT_NO_WHATSTHIS
        removeBut->setWhatsThis(QApplication::translate("PhraseBookBox", "Click here to remove the entry from the phrase book.", 0));
#endif // QT_NO_WHATSTHIS
        removeBut->setText(QApplication::translate("PhraseBookBox", "&Remove Entry", 0));
        settingsBut->setText(QApplication::translate("PhraseBookBox", "Settin&gs...", 0));
#ifndef QT_NO_WHATSTHIS
