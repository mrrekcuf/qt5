...
public:
    ...
    void setupUi(QDialog *FindDialog)
    {
        ...
        skipObsolete = new QCheckBox(groupBox);
        skipObsolete->setObjectName(QStringLiteral("skipObsolete"));

        gridLayout->addWidget(skipObsolete, 2, 1, 1, 1);
...
#ifndef QT_NO_WHATSTHIS
        skipObsolete->setWhatsThis(QApplication::translate("FindDialog", "Obsoleted messages are skipped when checked.", 0));
#endif // QT_NO_WHATSTHIS
        skipObsolete->setText(QApplication::translate("FindDialog", "Skip &obsolete", 0));
#ifndef QT_NO_WHATSTHIS
