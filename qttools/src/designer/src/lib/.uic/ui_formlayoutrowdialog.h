...
public:
    ...
    {
        FormLayoutRowDialog->setWindowTitle(QApplication::translate("FormLayoutRowDialog", "Add Form Layout Row", 0));
        labelTextLabel->setText(QApplication::translate("FormLayoutRowDialog", "&Label text:", 0));
        fieldClassLabel->setText(QApplication::translate("FormLayoutRowDialog", "Field &type:", 0));
        fieldNameLabel->setText(QApplication::translate("FormLayoutRowDialog", "&Field name:", 0));
        buddyLabel->setText(QApplication::translate("FormLayoutRowDialog", "&Buddy:", 0));
        buddyCheckBox->setText(QString());
        rowLabel->setText(QApplication::translate("FormLayoutRowDialog", "&Row:", 0));
        labelNameLabel->setText(QApplication::translate("FormLayoutRowDialog", "Label &name:", 0));
    } // retranslateUi
